...
class ZhihuSpider(scrapy.Spider):
    ...
    def parse(self, response):
        self.my_cookies = self.post_login()
        ...
        after_log_url = "https://www.zhihu.com"   #不能直接抓 "https://www.zhihu.com/"   登录后直接抓https://www.zhihu.com/   发现抓到的页面还是登录前的，必须换个链接抓，可能是哟缓存？
        #after_log_url = "https://www.baidu.com"
        #after_log_url = "https://doc.scrapy.org/en/latest/_static/selectors-sample1.html"
        yield scrapy.Request(after_log_url, callback=self.after_login,cookies=self.my_cookies)
